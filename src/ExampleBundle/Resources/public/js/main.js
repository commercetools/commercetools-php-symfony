...
jQuery(document).ready(function($){
  ...
  $("#form-search #search-input").attr("autocomplete", "off");
  ...
  $("#form-search #search-input").keypress(debounce(function () {
    $(".search-container").css("display", "block");

  }, 1));

  // ajax handling on search
  $("#form-search #search-input").on("keyup", debounce(function (event) {
    ...
    $.ajax({
      ...
      //check for input
      $("#form-search #search-input").on("keyup", function(){
